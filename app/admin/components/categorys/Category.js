...
if(this.props.match.params.textSearch == 0){
  ...
  axios.post('/categoryapi/find',{skip:skipStart,sort:'createdAt DESC',limit:10},{
    headers: {
      'authorization':tokenAuthorization,
    }
  }).then(function (res) {
    console.log(res,"res cate gory");
...
this.handleRequestSearch();
  ...
  axios.post("/categoryapi/search",infoSearch,{
    headers: {
      'authorization':tokenAuthorization,
    }
  }).then(function (res) {
...
handleRequest(pageNumber){
  ...
  let limit = 10
if(this.props.match.params.textSearch == 0){
  axios.post(`/categoryapi/find`,{sort:'createdAt DESC',limit:limit,skip:skipStart},{
    headers: {
      'authorization':tokenAuthorization,
    }
  }).then(function (res) {

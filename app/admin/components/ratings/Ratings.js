...
if(this.props.match.params.textSearch == " "){
  ...
  axios.post('/ratingapi/find',{skip:skipStart,sort:'createdAt DESC',limit:10},{
    headers: {
...
this.handleRequestSearch();
  ...
  axios.post("/ratingapi/search",infoSearch,{
    headers: {
      'authorization':tokenAuthorization,
    }
  }).then(function (res) {
...
handleRequestSearch(){
  var self=this;
  if(this.props.match.params.textSearch == " "){
    axios.post('/ratingapi/find',{sort:'createdAt DESC'},{
      headers: {
        'authorization':tokenAuthorization,
      }
    }).then(function (res) {
...
handleRequest(pageNumber){
  ...
  let limit = 10
if(this.props.match.params.textSearch == " "){
  axios.post(`/ratingapi/find`,{sort:'createdAt DESC',limit:limit,skip:skipStart},{
    headers: {
      'authorization':tokenAuthorization,
    }
  }).then(function (res) {
...
this.setState({
  displayModal:"none"
        ...
        <button type="button" onClick={
          () => {
            var self = this;
            axios.post('/ratingapi/destroy', { id: self.state.idRating },{
              headers: {
                'authorization':tokenAuthorization,
              }
            }).then(function (res) {

...
if(this.props.match.params.textSearch == " "){
  ...
  axios.post('/productsapi/find',{skip:skipStart,sort:'createdAt DESC',limit:10},{
    headers: {
...
this.handleRequestSearch();
  ...
  axios.post("/productsapi/search",infoSearch,{
    headers: {
      'authorization':tokenAuthorization,
    }
  }).then(function (res) {
...
handleRequestSearch(){
  var self=this;
  if(this.props.match.params.textSearch == " "){
    axios.post('/productsapi/find',{sort:'createdAt DESC'},{
      headers: {
        'authorization':tokenAuthorization,
      }
    }).then(function (res) {
...
handleRequest(pageNumber){
  ...
  let limit = 10
if(this.props.match.params.textSearch == " "){
  axios.post(`/productsapi/find`,{sort:'createdAt DESC',limit:limit,skip:skipStart},{
    headers: {
      'authorization':tokenAuthorization,
    }
  }).then(function (res) {
...
this.setState({
  displayModal:"none"
        ...
        <button type="button" onClick={
          () => {
            var self = this;
            axios.post('/productsapi/destroy', { id: self.state.idRating },{
              headers: {
                'authorization':tokenAuthorization,
              }
            }).then(function (res) {

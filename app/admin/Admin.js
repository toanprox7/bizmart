...
if(this.state.isToggle == false){
    ...
    if(this.state.phone_or_email && this.state.password != ""){
      ...
      if(re.test(this.state.phone_or_email) == true){
        let self=this;
        axios.post('/usersapi/loginAdmin',{email:this.state.phone_or_email,password:this.state.password},{
          headers: {
        ...
        let self=this;
        axios.post('/usersapi/loginAdmin',{phone_number:this.state.phone_or_email,password:this.state.password},{
          headers: {
            'authorization':tokenAuthorization,
          }
        }).then(function (res) {
...
if(this.state.phone_or_email != ""){
  ...
  if(re.test(this.state.phone_or_email) == true){
    ...
    axios.post("/usersapi/sendEmail",{email:this.state.phone_or_email,token:tokenEmail},{
      headers: {
        'authorization':tokenAuthorization,
      }
    }).then(function (res) {

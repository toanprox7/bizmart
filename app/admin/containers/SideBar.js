...
this.setState({
  ...
  }else if(Link.indexOf("/banners") !== -1){
    this.setState({
      activeRatings:"",
      activeBanners:"active treeview menu-open",
      activeCategorys:"",
      activeProducts:"",
      activeDashboard:"",
      activeUsers:""
  ...
  activeUsers:""
      ...
      <li onClick={()=>{
          this.setState({
            ...
            activeCategorys:"",
            activeProducts:"",
            activeMails:"active treeview menu-open",
            activeBanners:"",
            activeUsers:""
          });
      }} className={this.state.activeMails}>
        <Link to="/admin/mails/ /page-1.html">
          <i className="fa fa-envelope-o" /> <span>Quản lý phản hồi</span>
        </Link>
      </li>
       <li onClick={()=>{
this.setState({
  ...
  activeUsers:""
      ...
      }} className={this.state.activeBanners}>
        <Link to="/admin/banners/ /page-1.html">
          <i className="fa fa-dashboard" /> <span>Quản lý banner</span>
        </Link>
      </li> 

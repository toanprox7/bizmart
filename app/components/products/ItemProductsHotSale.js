...
const data = this.props.data;
 ...
 <div className="thumbnail">
                <Link to={`/details/${ChangeToSlug(data.title)}-${data.id}-${data.categoryId.id}`}><img className="img-responsive" src={`/images/upload/small/${this.handleLinkImage()}`} alt="img_product" /></Link>

...
componentDidMount() {
    var self=this; axios.post('/productsapi/find',{ limit:6, sort:'createdAt DESC', status:'active', total_star:{ '>=': 4 } }).then(res => { self.setState({ data:res.data }) }).catch(err => console.log(err));
    }
render() {
    return (

...
class PaginationProductsMyselfRight extends Component {
  ...
  componentDidMount() {
    ...
    let self =this;
    axios.post(`/productsapi/find`,{price:{ '>=': parseInt(start),'<=': parseInt(end) },status:'active',total_star:{ '>=': 4 }},{
      headers: {
...
componentWillReceiveProps(nextProps) {
  ...
  handleRedirect(numberPage){
    this.props.history.push(`/products-myself/${numberPage}/${this.props.price}`);
  }
  checkTotal(){

...
axios.post("/mail/send",info,{
  headers:{
    'authorization':tokenAuthorization,
  }
}).then(res => {
  if(res.data === "success"){
    alert("Cám ơn bạn đã gửi ý kiến của bạn cho chúng tôi, chúng tôi sẽ phản hồi ý kiến của bạn sớm nhất");
    setTimeout(()=>{
          ...
          <div className="block-contact">
            ...
            <div className="row">
              ...
              <div className="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                ...
                <AvForm onSubmit={(events,errors,value)=>this.handleSubmit(events,errors,value)}>
